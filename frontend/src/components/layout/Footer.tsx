        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">CAMS</span>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              Centralized Application Management System - Streamline your database operations with enterprise-grade security and monitoring.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/contact-sales" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Contact Sales
                </Link>
              </li>
              <li>
